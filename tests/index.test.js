...
describe.skip("Authentication", () => {
    ...
    test('Signup request fails if the username is empty', async () => {
        const username = `utkarsh-${Math.random()}` // utkarsh-0.12312313
        const password = "123456"
...
describe.skip("Arena endpoints", () => {
    ...
    test("Delete endpoint is able to delete an element", async () => {
        ...
        // console.log("PRINT response: " ,response.data.elements[0].id )
        ...
        // console.log("LengthParamCheck: ",newResponse.data.element)//receiving this as undefined.
        // console.log("LengthCheck: ",newResponse.data.element.length) //Length should be 0?
